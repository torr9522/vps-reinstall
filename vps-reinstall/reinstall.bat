...
set confhome=https://raw.githubusercontent.com/torr9522/vps-reinstall/vps-reinstall/vps-reinstall
set confhome_cn=
rem confhome_cn intentionally disabled in this vendored branch.
